<?php
namespace UltimatePostKit\Modules\SocialLink\Widgets;
...
use UltimatePostKit\Modules\SocialLink\Module;
...
class Social_Link extends Module_Base {
	...
	public function get_title() {
		return BDTUPK . esc_html__( 'Social Link', 'ultimate-post-kit' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Link Buttons', 'ultimate-post-kit' ),
			]
		);
		...
		$repeater->add_control(
            ...
            [
                'label'        => esc_html__('Custom Style', 'ultimate-post-kit'),
		...
		$repeater->add_control(
			'social_link',
			[
				'label'   => __('Link', 'ultimate-post-kit'),
				'type'    => Controls_Manager::TEXT,
				'default' => __('http://www.facebook.com/bdthemes/', 'ultimate-post-kit'),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => [
					[ 
						'button'      => 'facebook',
						'social_link' => __('http://www.facebook.com/bdthemes/', 'ultimate-post-kit'), 
					],
					[ 
						'button'      => 'linkedin',
						'social_link' => __('http://www.linkedin.com/bdthemes/', 'ultimate-post-kit'),
					],
					[ 
						'button'      => 'twitter', 
						'social_link' => __('http://www.twitter.com/bdthemes/', 'ultimate-post-kit'),
					],
					[ 
						'button'      => 'pinterest',
						'social_link' => __('http://www.pinterest.com/bdthemes/', 'ultimate-post-kit'),
					],
				],
				'title_field' => '{{{ button  }}}',
			]
		...
		$this->add_control(
			'icon_top',
			[
				'label'        => __( 'Icon Position Top', 'ultimate-post-kit' ),
		...
		$this->add_responsive_control(
            'ss_icon_padding',
            [
                'label'      => __('Icon Padding', 'ultimate-post-kit'),
		...
		$this->add_responsive_control(
            'ss_text_padding',
            [
                'label'      => __('Text Padding', 'ultimate-post-kit'),
                'type'       => Controls_Manager::DIMENSIONS,
                'size_units' => ['px', '%', 'em'],
                'selectors'  => [
