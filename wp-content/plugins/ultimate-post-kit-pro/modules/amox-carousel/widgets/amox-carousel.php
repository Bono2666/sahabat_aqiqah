	...
	protected function register_controls() {
		...
		if (upk_fs()->is__premium_only()) {
			$this->add_responsive_control(
				...
				[
					'label'       => __('Active Item Alignment', 'ultimate-post-kit'),
					'type'        => Controls_Manager::CHOOSE,
					'options'     => [
						'left'   => [
							'title' => __('Left', 'ultimate-post-kit'),
					...
					'selectors'   => [
						'{{WRAPPER}} .upk-amox-carousel .upk-item.active .upk-content, {{WRAPPER}}.upk-amox-carousel-active--yes .upk-item.swiper-slide-active .upk-content' => 'text-align: {{VALUE}};',
					],
					'condition' => [
						'active_item!' => ''
					]
		...
		if (upk_fs()->is__premium_only()) {
			$this->add_responsive_control(
				...
				[
					'label' 	 => __('Active Content Padding', 'ultimate-post-kit'),
					'type' 		 => Controls_Manager::DIMENSIONS,
					'size_units' => ['px', 'em', '%'],
					'selectors'  => [
						'{{WRAPPER}} .upk-amox-carousel .upk-item.active .upk-content, {{WRAPPER}}.upk-amox-carousel-active--yes .upk-item.swiper-slide-active .upk-content' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					],
				]
			);
		}
		...
		if (upk_fs()->is__premium_only()) {
			$this->add_control(
				'item_overlay_color',
				[
					'label'     => esc_html__('Active Overlay Color', 'ultimate-post-kit'),
					'type'      => Controls_Manager::COLOR,
					'selectors' => [
						'{{WRAPPER}} .upk-amox-carousel .upk-item.active .upk-img-wrap::before, {{WRAPPER}}.upk-amox-carousel-active--yes .upk-item.swiper-slide-active .upk-img-wrap::before' => 'background: {{VALUE}};',
					],
				]
			);
		}
		...
		if (upk_fs()->is__premium_only()) {
			$this->add_control(
				...
				[
					...
					'type'      => Controls_Manager::COLOR,
					'selectors' => [
						'{{WRAPPER}} .upk-amox-carousel .upk-item:hover.active .upk-img-wrap::before, {{WRAPPER}}.upk-amox-carousel-active--yes .upk-item:hover.swiper-slide-active .upk-img-wrap::before' => 'background:  {{VALUE}};',
					],
				]
			);
		}
		...
		if (upk_fs()->is__premium_only()) {
			$this->add_control(
				...
				[
					...
					'type'      => Controls_Manager::COLOR,
					'selectors' => [
						'{{WRAPPER}} .upk-amox-carousel .upk-item.active .upk-title a, {{WRAPPER}}.upk-amox-carousel-active--yes .upk-item.swiper-slide-active .upk-title a' => 'color: {{VALUE}};',
					],
				]
			);
		}
		...
		if (upk_fs()->is__premium_only()) {
			$this->add_control(
				...
				[
					...
					'type'      => Controls_Manager::COLOR,
					'selectors' => [
						'{{WRAPPER}} .upk-amox-carousel .upk-item.active .upk-title a:hover, {{WRAPPER}}.upk-amox-carousel-active--yes .upk-item.swiper-slide-active .upk-title a:hover' => 'color: {{VALUE}};',
					],
				]
			);
		}
		...
		if (upk_fs()->is__premium_only()) {
			$this->add_control(
				...
				[
					...
					'type'      => Controls_Manager::COLOR,
					'selectors' => [
						'{{WRAPPER}} .upk-amox-carousel .upk-item.active .upk-meta, {{WRAPPER}}.upk-amox-carousel-active--yes .upk-item.swiper-slide-active .upk-meta' => 'color: {{VALUE}};',
					],
				]
			);
		}
		...
		if (upk_fs()->is__premium_only()) {
			...
			$this->add_control(
				...
				[
					...
					'type'      => Controls_Manager::COLOR,
					'selectors' => [
						'{{WRAPPER}} .upk-amox-carousel .upk-item.active .upk-category a, {{WRAPPER}}.upk-amox-carousel-active--yes .upk-item.swiper-slide-active .upk-category a' => 'color: {{VALUE}};',
					],
				]
			);
			...
			$this->add_group_control(
				...
				[
					...
					'selector' => '{{WRAPPER}} .upk-amox-carousel .upk-item.active .upk-category a, {{WRAPPER}}.upk-amox-carousel-active--yes .upk-item.swiper-slide-active .upk-category a',
				]
			);
			...
			$this->add_control(
				...
				[
					...
					'selectors' => [
						'{{WRAPPER}} .upk-amox-carousel .upk-item.active .upk-category a, {{WRAPPER}}.upk-amox-carousel-active--yes .upk-item.swiper-slide-active .upk-category a' => 'border-color: {{VALUE}};',
					],
				]
			);
			...
			$this->add_control(
				...
				[
					...
					'type'      => Controls_Manager::COLOR,
					'selectors' => [
						'{{WRAPPER}} .upk-amox-carousel .upk-item.active .upk-category a:hover, {{WRAPPER}}.upk-amox-carousel-active--yes .upk-item.swiper-slide-active .upk-category a:hover' => 'color: {{VALUE}};',
					],
				]
			);
			...
			$this->add_group_control(
				...
				[
					...
					'selector' => '{{WRAPPER}} .upk-amox-carousel .upk-item.active .upk-category a:hover, {{WRAPPER}}.upk-amox-carousel-active--yes .upk-item.swiper-slide-active .upk-category a:hover',
				]
			);
			...
			$this->add_control(
				...
				[
					...
					'selectors' => [
						'{{WRAPPER}} .upk-amox-carousel .upk-item.active .upk-category a:hover, {{WRAPPER}}.upk-amox-carousel-active--yes .upk-item.swiper-slide-active .upk-category a:hover' => 'border-color: {{VALUE}};',
					],
				]
			);
			...
			<div class="upk-post-wrapper">
				...
				public function render() {
					...
					while ($wp_query->have_posts()) {
						...
						if (upk_fs()->is__premium_only()) {
							if ($settings['carousel_active_item'] == '') {
								$active_item = (isset($settings['active_item']) && !empty($settings['active_item'])) ? $settings['active_item'] : 2;
								$i++;
								$active_item = $i == $settings['active_item'] ? 'active' : '';
							} else {
								$active_item = '';
							}
						} else {
