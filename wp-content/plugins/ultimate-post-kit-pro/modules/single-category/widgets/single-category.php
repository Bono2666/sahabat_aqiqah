...
namespace UltimatePostKit\Modules\SingleCategory\Widgets;
...
class Single_Category extends Group_Control_Query {
	// use Global_Widget_Controls;
	public function get_name() {
		return 'upk-single-category';
	}
	...
	public function get_icon() {
		return 'upk-widget-icon upk-icon-category';
	}
	...
	public function get_keywords() {
		return ['post', 'grid', 'blog', 'recent', 'news', 'category'];
	}
	...
	protected function render() {
		printf('<div>%s</div>', get_the_category_list(' '));
	}
}
