	...
	protected function register_controls() {
		...
		if (upk_fs()->is__premium_only()) {
			$this->start_controls_section(
				...
				[
					'label'     => esc_html__('Top Stories', 'ultimate-post-kit'),
					'tab'       => Controls_Manager::TAB_STYLE,
					'condition' => [
			...
			$this->add_control(
				...
				[
					'label'     => esc_html__('Header Text Color', 'ultimate-post-kit'),
					'type'      => Controls_Manager::COLOR,
					'selectors' => [
			...
			$this->start_controls_tabs('tabs_top_stories_style');
...
?>
	...
	?>
		<div class="upk-skide-slider-wrap">
			...
			<?php if (upk_fs()->is__premium_only()) : ?>
				<?php $this->render_top_stories(); ?>
			<?php endif; ?>
