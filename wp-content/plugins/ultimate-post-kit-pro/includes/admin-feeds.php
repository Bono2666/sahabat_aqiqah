...
class Ultimate_Post_Kit_Admin_Feeds {
    ...
    public function enqueue_styles() {
        $suffix = is_rtl() ? '.rtl' : '';
        wp_enqueue_style('ultimate-post-kit-admin', BDTUPK_URL . 'admin/assets/css/admin' . $suffix . '.css', [], BDTUPK_VER);
    }
    /**
    ...
    public function ultimate_post_kit_get_feeds_remote_data() {
        $source = wp_remote_get('https://bdthemes.com/wp-json/bdthemes/v1/product-feed/?product_category=ultimate-post-kit');
