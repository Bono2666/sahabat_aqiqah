...
class Ultimate_Post_Kit_Loader {
	...
	private function _includes() {
		...
		if (is_admin()) {
			if (!defined('BDTEP_CH')) {
				require(BDTUPK_INC_PATH . 'admin-feeds.php');
	...
	public function register_site_styles() {
		...
		wp_register_style('ultimate-post-kit-font', BDTUPK_ASSETS_URL . 'css/ultimate-post-kit-font' . $direction_suffix . '.css', [], BDTUPK_VER);
	}
	...
	public function enqueue_site_styles() {
		...
		wp_enqueue_style('ultimate-post-kit-site', BDTUPK_ASSETS_URL . 'css/ultimate-post-kit-site' . $direction_suffix . '.css', [], BDTUPK_VER);
	}
	...
	public function enqueue_site_scripts() {
		...
		wp_enqueue_script('ultimate-post-kit-site', BDTUPK_ASSETS_URL . 'js/ultimate-post-kit-site' . $suffix . '.js', [
			'jquery',
			'elementor-frontend'
	...
	public function enqueue_editor_scripts() {
		...
		wp_enqueue_script('ultimate-post-kit', BDTUPK_ASSETS_URL . 'js/ultimate-post-kit-editor' . $suffix . '.js', [
			'backbone-marionette',
	...
	public function enqueue_admin_scripts() {
		$suffix = defined('SCRIPT_DEBUG') && SCRIPT_DEBUG ? '' : '.min';
		wp_enqueue_script('ultimate-post-kit-admin', BDTUPK_ASSETS_URL . 'js/ultimate-post-kit-admin' . $suffix . '.js', ['jquery'], BDTUPK_VER, true);
	}
	...
	public function enqueue_preview_styles() {
		...
		wp_enqueue_style('ultimate-post-kit-preview', BDTUPK_ASSETS_URL . 'css/ultimate-post-kit-preview' . $direction_suffix . '.css', '', BDTUPK_VER);
	}
	...
	public function enqueue_editor_styles() {
		...
		wp_enqueue_style('ultimate-post-kit-font', BDTUPK_URL . 'assets/css/ultimate-post-kit-font' . $direction_suffix . '.css', [], BDTUPK_VER);
	}
	...
	public function ultimate_post_kit_category_register() {
		...
		if (upk_fs()->is__premium_only()) {
			$elementor->elements_manager->add_category(
				...
				[
					'title' => esc_html__('Ultimate Post Kit Pro', 'ultimate-post-kit'),
					'icon'  => 'font'
				]
			);
		}
