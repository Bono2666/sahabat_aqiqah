jQuery(document).ready(function($) {
    ...
    $('.mgo_wa.mgo_autofill input').bind('change', function(e){
		var wanya = $(this).val();
		$('.mgo_nama input').val(wanya).attr("value",wanya).prop("readonly", "readonly");
		$('input.mgo_nama').val(wanya).attr("value",wanya);
	});
	...
	$('.mgo_donasi2 input').addClass("donasi").after("<div class='text_rp'>Rp</div>");
	$('.mgo_donasi3 input').addClass("donasi").after("<div class='text_rp'>Rp</div>");
	$('.mgo_donasi4 input').addClass("donasi").after("<div class='text_rp'>Rp</div>");
	$('.mgo_donasi5 input').addClass("donasi").after("<div class='text_rp'>Rp</div>");
	...
	// $('.mgo_donasi input').on('keyup', function(e){
	// 	// alert(1);
	// 	if(event.which >= 37 && event.which <= 40) return;
	// 	$(this).val(function(index, value) {
	// 		// return value.replace(/\D/g, "").replace(/\B(?=(\d{3})+(?!\d))/g, ".");
	...
	// 	$(this).val(function(index, value) {
	// 		console.log(value);
	// 		var nilai = nilai_donasinya.replace(/\D/g, "").replace(/\B(?=(\d{3})+(?!\d))/g, ".");
	// 		// donasi_utamanya = nilai_donasinya.replace(/\./g,"");
	// 	});
	// 	var abc = "calculation_total_"+id_caldera_form2+"()";
	// 	eval(abc);
	// });
