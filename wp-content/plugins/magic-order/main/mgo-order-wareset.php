...
function magic_order_data_wareset() {
    mgo_global_vars();
    ...
    <div class="wrap plugin_info"><h2 class="title" style="display: none;"></h2></div>
        ...
        ?>
        <!-- <div class="sub-title" style="padding-left:42px;padding-bottom: 40px;"><a href="<?php echo admin_url('admin.php?page=magic_order_data') ?>" style="text-decoration: none;" class="mgo_link"><span>Data Orders</span></a><span> > </span><a href="<?php echo admin_url('admin.php?page=magic_order_data_settings') ?>" style="text-decoration: none;" class="mgo_link"><span>Settings</span></a><span> > </span><span>Whatsapp Reset</span>
        </div> -->
        ...
        <header class="mgo-header">
            <h1 class="mgo-logo"><img class="icon-title2" src="<?php echo plugin_dir_url( __FILE__ ); ?>../assets/icons/magic-order-icon2.png"></h1>
              ...
              <a href="<?php echo admin_url('admin.php?page=magic_order_data_settings') ?>" style="cursor: pointer;position: absolute;right: 0;margin-top: 80px;margin-right: 50px;height: 0;width: 0;">
