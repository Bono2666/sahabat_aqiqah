...
function magic_order_autosave_wa_reset() {
    mgo_global_vars();
    ...
    <div class="wrap" style="box-shadow: 0 4px 25px 0 rgba(0,0,0,.1);border-radius: 4px;">
        ...
        <header class="mgo-header">
            <h1 class="mgo-logo"><img class="icon-title2" src="<?php echo plugin_dir_url( __FILE__ ); ?>../assets/icons/magic-order-icon2.png"></h1>
              ...
              <a href="<?php echo admin_url('admin.php?page=magic_order_autosave_wa_settings') ?>" style="cursor: pointer;position: absolute;right: 0;margin-top: 80px;margin-right: 50px;height: 0;width: 0;">
                ...
                buttons: {   
                    ...
                    ok: {
                        ...
                        action: function(e){
                            ...
                            var data = {
                                "action": "myaction_reset_wa_autosave",
                                "datanya": data_nya
                            };
