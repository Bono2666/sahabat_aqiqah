...
if( ! class_exists('OptimizeMikadoSidebar') ){
	...
	class OptimizeMikadoSidebar{
		...
		function __construct(){
			...
			$this->title = esc_html__('Custom Widget Area','optimizewp');
		...
		function load_assets(){
			...
			wp_enqueue_script('optimize-mikado-sidebar' , MIKADO_ROOT . '/framework/admin/assets/js/mkdf-sidebar.js');
			wp_enqueue_style( 'optimize-mikado-sidebar' , MIKADO_ROOT . '/framework/admin/assets/css/mkdf-sidebar.css');
		}
		...
		function template_add_widget_field(){
			...
			echo "\n    <span class='input_wrap'><input type='text' value='' placeholder = '".esc_html__('Enter Name of the new Widget Area', 'optimizewp')."' name='mkd-add-widget' /></span>";
			echo "\n    <input class='button' type='submit' value='".esc_html__('Add Widget Area', 'optimizewp')."' />";
			echo "\n    ".$nonce;
			echo "\n  </form>";
			echo "\n</script>\n";
		}
