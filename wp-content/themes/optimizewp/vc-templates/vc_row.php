...
if($video == 'show_video'){
	...
	if($v_image) {
		$video_output .= '<img ' . optimize_mikado_get_inline_attr($v_image, 'src') . ' width="1920" height="800" title="'. esc_attr_e( 'No video playback capabilities', 'optimizewp' ) .'" alt="'. esc_attr_e( 'Video thumb', 'optimizewp' ).'" />';
	}
	$video_output .='</object>';
	$video_output .='</video>';
	$video_output .='</div>';
...
print optimize_mikado_get_module_part($output);