	...
	function optimize_mikado_content_bottom_options_map() {
		...
		$panel_content_bottom = optimize_mikado_add_admin_panel(
			array(
				...
				'title' => esc_html__( 'Content Bottom Area', 'optimizewp' )
			)
		);
		...
		optimize_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label' => esc_html__( 'Widget Area to Display', 'optimizewp' ),
			'description' => esc_html__( 'Choose a Content Bottom widget area to display', 'optimizewp' ),
