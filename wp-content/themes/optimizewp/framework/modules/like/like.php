...
class OptimizeMikadoLike {
	...
	function enqueue_scripts() {
		...
		wp_enqueue_script( 'optimize-mikado-like', MIKADO_ASSETS_ROOT . '/js/like.min.js', 'jquery', '1.0', TRUE );

		wp_localize_script( 'optimize-mikado-like', 'mkdfLike', array(
	...
	public function add_like() {
		...
		$title = esc_html__('Like this', 'optimizewp');
		if( isset($_COOKIE['mkdf-like_'. $post->ID]) ){
			$class = 'mkdf-like liked';
			$title = esc_html__('You already like this!', 'optimizewp');
		}
