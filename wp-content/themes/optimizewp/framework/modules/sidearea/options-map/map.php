	...
	function optimize_mikado_sidearea_options_map() {
		...
		optimize_mikado_add_admin_page(
			array(
				...
				'title' => esc_html__( 'Side Area', 'optimizewp' ),
				'icon' => 'fa fa-search'
			)
		);
		...
		optimize_mikado_add_admin_field(
			array(
				...
				'label' => esc_html__( 'Side Area Type', 'optimizewp' ),
				'description' => esc_html__( 'Choose a type of Side Area', 'optimizewp' ),
				'options' => array(
					'side-menu-slide-from-right' => esc_html__('Slide from Right Over Content', 'optimizewp' ),
					'side-menu-slide-with-content' => esc_html__('Slide from Right With Content', 'optimizewp' ),
					'side-area-uncovered-from-content' => esc_html__('Side Area Uncovered from Content', 'optimizewp' )
				),
				'args' => array(
					'dependence' => true,
					'hide' => array(
		...
		optimize_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label' => esc_html__( 'Side Area Width', 'optimizewp' ),
				'description' => esc_html__( 'Enter a width for Side Area (in percentages, enter more than 30)', 'optimizewp' ),
				'args' => array(
					'col_width' => 3,
					'suffix' => '%'
				)
		...
		optimize_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label' => esc_html__( 'Content Overlay Background Color', 'optimizewp' ),
				'description' => esc_html__( 'Choose a background color for a content overlay', 'optimizewp' ),
			)
		);
		...
		optimize_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label' => esc_html__( 'Content Overlay Background Transparency', 'optimizewp' ),
				'description' => esc_html__( 'Choose a transparency for the content overlay background color (0 = fully transparent, 1 = opaque)', 'optimizewp' ),
				'args' => array(
					'col_width' => 3
				)
			)
		...
		optimize_mikado_add_admin_field(
			array(
				...
				'label' => esc_html__( 'Side Area Width', 'optimizewp' ),
				'description' => esc_html__( 'Choose width for Side Area', 'optimizewp' ),
				'options' => array(
					'width-270' => '270px',
					'width-370' => '370px',
					'width-470' => '470px'
		...
		optimize_mikado_add_admin_field(array(
				...
				'label' => esc_html__( 'Side Area Background Image', 'optimizewp' ),
				'description' => esc_html__( 'Choose background image for Side Area', 'optimizewp' )
			)
		);
		...
		optimize_mikado_add_admin_field(
			array(
				...
				'default_value' => 'yes',
				'label' => esc_html__( 'Enable Default Side Area Opener Icon', 'optimizewp' ),
				'description' => esc_html__( 'Enabling this option will enable default side area opener icon', 'optimizewp' ),
				'args' => array(
					'dependence' => true,
...
//do we have some collection added in collections array?
		...
		optimize_mikado_add_admin_field(
			array(
				...
				'label' => esc_html__( 'Side Area Button Icon Pack', 'optimizewp' ),
				'description' => esc_html__( 'Choose icon pack for side area button', 'optimizewp' ),
			...
			foreach (optimize_mikado_icon_collections()->iconCollections as $collection_key => $collection_object) {
				...
				optimize_mikado_add_admin_field(
					array(
						...
						'label' => esc_html__( 'Side Area Icon', 'optimizewp' ),
						'description' => esc_html__( 'Choose Side Area Icon', 'optimizewp' ),
						'options' => $icons_array,
					)
				);
		...
		optimize_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label' => esc_html__( 'Side Area Icon Size', 'optimizewp' ),
				'description' => esc_html__( 'Choose a size for Side Area (px)', 'optimizewp' ),
				'args' => array(
					'col_width' => 3,
					'suffix' => 'px'
				),
		...
		optimize_mikado_add_admin_field(
			array(
				...
				'label' => esc_html__( 'Predefined Side Area Icon Size', 'optimizewp' ),
				'description' => esc_html__( 'Choose predefined size for Side Area icons', 'optimizewp' ),
				'options' => array(
					'normal' => esc_html__('Normal', 'optimizewp' ),
		...
		$side_area_icon_style_group = optimize_mikado_add_admin_group(
			array(
				...
				'title' => esc_html__( 'Side Area Icon Style', 'optimizewp' ),
				'description' => esc_html__( 'Define styles for Side Area icon', 'optimizewp' )
			)
		);
		...
		optimize_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label' => esc_html__( 'Light Menu Icon Color', 'optimizewp' ),
			)
		);
		...
		optimize_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label' => esc_html__( 'Light Menu Icon Hover Color', 'optimizewp' ),
			)
		);
		...
		optimize_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label' => esc_html__( 'Dark Menu Icon Color', 'optimizewp' ),
			)
		);
		...
		optimize_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label' => esc_html__( 'Dark Menu Icon Hover Color', 'optimizewp' ),
			)
		);
		...
		$icon_spacing_group = optimize_mikado_add_admin_group(
			array(
				...
				'title' => esc_html__( 'Side Area Icon Spacing', 'optimizewp' ),
				'description' => esc_html__( 'Define padding and margin for side area icon', 'optimizewp' )
			)
		);
		...
		optimize_mikado_add_admin_field(
			array(
				...
				'default_value' => 'no',
				'label' => esc_html__( 'Icon Border', 'optimizewp' ),
		...
		$border_style_group = optimize_mikado_add_admin_group(
			array(
				...
				'title' => esc_html__( 'Border Style', 'optimizewp' ),
				'description' => esc_html__( 'Define styling for border around icon', 'optimizewp' )
			)
		);
		...
		optimize_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label' => esc_html__( 'Width', 'optimizewp' ),
				'args' => array(
					'suffix' => 'px'
				)
			)
		...
		optimize_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label' => esc_html__( 'Radius', 'optimizewp' ),
				'args' => array(
					'suffix' => 'px'
				)
			)
		...
		optimize_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label' => esc_html__( 'Text Aligment', 'optimizewp' ),
				'description' => esc_html__( 'Choose text aligment for side area', 'optimizewp' ),
				'options' => array(
		...
		optimize_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label' => esc_html__( 'Side Area Title', 'optimizewp' ),
				'description' => esc_html__( 'Enter a title to appear in Side Area', 'optimizewp' ),
				'args' => array(
					'col_width' => 3,
				)
			)
		...
		optimize_mikado_add_admin_field(
			array(
				...
				'description' => esc_html__( 'Choose a background color for Side Area', 'optimizewp' ),
			)
		);
		...
		$padding_group = optimize_mikado_add_admin_group(
			array(
				...
				'description' => esc_html__( 'Define padding for Side Area', 'optimizewp' )
			)
		);
		...
		optimize_mikado_add_admin_field(
			array(
				...
				'default_value' => 'light',
				'label' => esc_html__( 'Close Icon Style', 'optimizewp' ),
				'description' => esc_html__( 'Choose a type of close icon', 'optimizewp' ),
				'options' => array(
		...
		optimize_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label' => esc_html__( 'Close Icon Size', 'optimizewp' ),
				'description' => esc_html__( 'Define close icon size', 'optimizewp' ),
				'args' => array(
					'col_width' => 3,
					'suffix' => 'px'
				)
		...
		$title_group = optimize_mikado_add_admin_group(
			array(
				...
				'description' => esc_html__( 'Define Style for Side Area title', 'optimizewp' )
			)
		);
		...
		$text_group = optimize_mikado_add_admin_group(
			array(
				'parent' => $side_area_panel,
				'name' => 'text_group',
				'title' => esc_html__( 'Text', 'optimizewp' ),
				'description' => esc_html__( 'Define Style for Side Area text', 'optimizewp' )
			)
		);
		...
		$widget_links_group = optimize_mikado_add_admin_group(
			array(
				...
				'title' => esc_html__( 'Link Style', 'optimizewp' ),
				'description' => esc_html__( 'Define styles for Side Area widget links', 'optimizewp' )
			)
		);
		...
		optimize_mikado_add_admin_field(
			array(
				...
				'default_value' => 'no',
				'label' => esc_html__( 'Border Bottom on Elements', 'optimizewp' ),
				'description' => esc_html__( 'Enable border bottom on elements in side area', 'optimizewp' ),
				'args' => array(
					'dependence' => true,
					'dependence_hide_on_yes' => '',
		...
		optimize_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label' => esc_html__( 'Border Bottom Color', 'optimizewp' ),
				'description' => esc_html__( 'Choose color for border bottom on elements in sidearea', 'optimizewp' )
			)
		);
