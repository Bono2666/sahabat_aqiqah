...
if ( ! function_exists('optimize_mikado_contact_form_7_options_map') ) {
	...
	function optimize_mikado_contact_form_7_options_map() {
		...
		optimize_mikado_add_admin_page(array(
			...
			'title' => esc_html__( 'Contact Form 7', 'optimizewp' ),
		...
		$panel_contact_form_style_1 = optimize_mikado_add_admin_panel(array(
			...
			'title' => esc_html__( 'Custom Style 1', 'optimizewp' )
		));
		...
		$typography_text_group = optimize_mikado_add_admin_group(array(
			...
			'title' => esc_html__( 'Form Text Typography', 'optimizewp' ),
			'description' => esc_html__( 'Setup typography for form elements text', 'optimizewp' ),
		...
		optimize_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label' => esc_html__( 'Focus Text Color', 'optimizewp' ),
		));
		...
		$typography_label_group = optimize_mikado_add_admin_group(array(
			...
			'title' => esc_html__( 'Form Label Typography', 'optimizewp' ),
			'description' => esc_html__( 'Setup typography for form elements label', 'optimizewp' ),
			'parent'		=> $panel_contact_form_style_1
		));
		...
		$background_border_group = optimize_mikado_add_admin_group(array(
			...
			'title' => esc_html__( 'Form Elements Background and Border', 'optimizewp' ),
			'description' => esc_html__( 'Setup form elements background and border style', 'optimizewp' ),
			'parent'		=> $panel_contact_form_style_1
		));
		...
		optimize_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label' => esc_html__( 'Focus Background Color', 'optimizewp' )
		));
		...
		optimize_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label' => esc_html__( 'Focus Background Transparency', 'optimizewp' )
		));
		...
		optimize_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label' => esc_html__( 'Border Transparency', 'optimizewp' ),
		));
		...
		optimize_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label' => esc_html__( 'Focus Border Color', 'optimizewp' )
		));
		...
		optimize_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label' => esc_html__( 'Focus Border Transparency', 'optimizewp' )
		));
		...
		optimize_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label' => esc_html__( 'Border Width', 'optimizewp' ),
			'args'			=> array(
				'suffix' => 'px'
			)
		));
		...
		optimize_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label' => esc_html__( 'Border Radius', 'optimizewp' ),
			'args'			=> array(
				'suffix' => 'px'
			)
		));
		...
		$padding_group = optimize_mikado_add_admin_group(array(
			'name'			=> 'padding_group',
			'title' => esc_html__( 'Elements Padding', 'optimizewp' ),
			'description' => esc_html__( 'Setup form elements padding', 'optimizewp' ),
			'parent'		=> $panel_contact_form_style_1
		));
		...
		optimize_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label' => esc_html__( 'Padding Top', 'optimizewp' ),
			'args'			=> array(
				'suffix' => 'px'
			)
		));
		...
		optimize_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label' => esc_html__( 'Padding Bottom', 'optimizewp' ),
			'args'			=> array(
				'suffix' => 'px'
			)
		));
		...
		$margin_group = optimize_mikado_add_admin_group(array(
			'name'			=> 'margin_group',
			'title' => esc_html__( 'Elements Margin', 'optimizewp' ),
			'description' => esc_html__( 'Setup form elements margin', 'optimizewp' ),
			'parent'		=> $panel_contact_form_style_1
		));
		...
		optimize_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label' => esc_html__( 'Margin Top', 'optimizewp' ),
			'args'			=> array(
				'suffix' => 'px'
			)
		));
		...
		optimize_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label' => esc_html__( 'Margin Bottom', 'optimizewp' ),
			'args'			=> array(
				'suffix' => 'px'
			)
		));
		...
		optimize_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label' => esc_html__( 'Textarea Height', 'optimizewp' ),
			'description' => esc_html__( 'Enter height for textarea form element', 'optimizewp' ),
			'args'			=> array(
				'col_width' => '3',
				'suffix' => 'px'
			)
		...
		$button_typography_group = optimize_mikado_add_admin_group(array(
			...
			'title' => esc_html__( 'Button Typography', 'optimizewp' ),
			'description' => esc_html__( 'Setup button text typography', 'optimizewp' ),
			'parent'		=> $panel_contact_form_style_1
		));
		...
		$button_background_border_group = optimize_mikado_add_admin_group(array(
			...
			'title' => esc_html__( 'Button Background and Border', 'optimizewp' ),
			'description' => esc_html__( 'Setup button background and border style', 'optimizewp' ),
			'parent'		=> $panel_contact_form_style_1
		));
		...
		optimize_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label' => esc_html__( 'Background Hover Transparency', 'optimizewp' )
		));
		...
		optimize_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label' => esc_html__( 'Border Hover Transparency', 'optimizewp' )
		));
		...
		optimize_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label' => esc_html__( 'Button Height', 'optimizewp' ),
			'description' => esc_html__( 'Insert form button height', 'optimizewp' ),
			'args'			=> array(
				'col_width' => '3',
				'suffix' => 'px'
			)
		...
		optimize_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label' => esc_html__( 'Button Left/Right Padding', 'optimizewp' ),
			'description' => esc_html__( 'Enter value for button left and right padding', 'optimizewp' ),
			'args'			=> array(
				'col_width' => '3',
				'suffix' => 'px'
			)
		...
		$panel_contact_form_style_2 = optimize_mikado_add_admin_panel(array(
			...
			'title' => esc_html__( 'Custom Style 2', 'optimizewp' )
		));
		...
		$panel_contact_form_style_3 = optimize_mikado_add_admin_panel(array(
			...
			'title' => esc_html__( 'Custom Style 3', 'optimizewp' )
		));
